...
1. **Text-only baseline.** OCR/text-extraction → chunk → dense embedding (open multilingual
   text embedder: BGE-M3 or multilingual-e5) + BM25 hybrid + cross-encoder reranker. Represents
   "what everyone already builds" and sets the floor.
